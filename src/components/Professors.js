...
const Professors = () => {
  ...
  const [professors, setProfessors] = useState([
    { prof_id: "1", prof_name: "hffhf", prof_dept: "fnfnff" },
    { prof_id: "2", prof_name: "hffhf", prof_dept: "fnfnff" },
    { prof_id: "3", prof_name: "hffhf", prof_dept: "fnfnff" },
  ]);
  const addProf = () => {
  ...
  return (
    <div>
      <h1 className="appTitle">Add professors</h1>
      <form>
